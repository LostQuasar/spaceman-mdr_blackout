...
class MDR_300BLACKOUT_BLACK {
    static onLoadMod() {        
        const itemId = "MDR_300BLACKOUT_BLACK";
        const itemClone = "5c488a752e221602b412af63";
        const itemCategory = "5b5f78fc86f77409407a7f90";
        const itemPrefabPath = "BlackoutMDR/weapon_dt_mdr_556x45_container.bundle"
        const itemFleaPrice = 57230;
        const itemLongName = "DT MDR .300 AAC Blackout Assault Rifle (Black)";
...
module.exports = MDR_300BLACKOUT_BLACK;